...
from app.model3.model.basemodel import BaseModel
from app.model3.model.basenet import BaseNet
from app.model3.model.loss import VGGLoss
from app.model3.model.layer import init_weights, ConfidenceDrivenMaskLayer
import numpy as np
from app.model3.util.utils import generate_mask
...
class InpaintingModel_DFBM(BaseModel):
    def __init__(self, act=F.elu, opt=None):
        ...
        self.zeros = torch.zeros((opt.batch_size, 1)) 
        self.ones = torch.ones((opt.batch_size, 1)) 
        ...
        self.netD = GlobalLocalDiscriminator(3, cnum=opt.d_cnum, act=F.leaky_relu) 
